...
# load data
df_data = pd.read_csv("../Data/MOF_data_test.csv")
# rename targets
...
final_descriptors = ["PLD log10", "LCD log10", "Density (g/cc)", "VSA (m2/cc)", "VF", "Qst_CH4", "Qst_CO2", "Qst_H2S",
                     "Qst_H2O"]
target_descriptors = df_data[targets + final_descriptors]
...
df_descriptors = target_descriptors[final_descriptors]
...
descriptor_corr = corr_graph(df_data[final_descriptors], "Test Set Correlation",
                             "corr_plot")
